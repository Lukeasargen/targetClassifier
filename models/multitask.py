...
def load_multitask_resnet(path, device):
...
class MultiTaskNet(nn.Module):
    """ https://github.com/pangwong/pytorch-multi-label-classifier/blob/4c90b994250a66c3731baecf4bdc878696840e1e/models/build_model.py """
